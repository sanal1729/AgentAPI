// <copyright file="ExceptionDetailsFactory.cs" company="Agent">
// © Agent 2025
// </copyright>

namespace Agent.Api.Common.Errors
{
    using System;
    ...
    public class ExceptionDetailsFactory(IOptions<ApiBehaviorOptions> options) : ProblemDetailsFactory
    {
